...
<div class="col-md-5">
  ...
  <div class="block block-rounded block-themed">
     ...
     <div class="form-group row">
      ...
      <div class="col-12">
        <select class='form-control' id="identificacion" name="identificacion" required>
         ...
         <?php } ?>
         <option value="Cédula de identidad">DNI</option>
         <option value="Cédula de extranjería">Carnet de extranjería</option>
         <option value="Pasaporte">Pasaporte</option>
         <option value="NIF o NIT">PTP o CPP</option>
         <option value="DUI">Otros</option>
       </select>
     </div>
   </div>
   ...
   <div class="form-group row">
    ...
    <?php }else{ ?>
      <input type="text" class="form-control" id="numidentificacion"  name="numidentificacion" placeholder="00000000" pattern="[0-8]*"  title="Solo números" required>
    <?php } ?>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-12">
    <?php if ($resultPerfil==1) { ?>
      <input type="text" class="form-control" id="Celular"  name="Celular" value="<?php echo$Celular ?>" required  placeholder="+00 000000000"  pattern="[\(]?[\+]?(\d{2}|\d{3})[\)]?[\s]?((\d{6}|\d{8})|(\d{3}[\*\.\-\s]){3}|(\d{2}[\*\.\-\s]){4}|(\d{4}[\*\.\-\s]){2})|\d{8}|\d{10}|\d{12}" title="+### ########">

    <?php }else{ ?>
      <input type="text" class="form-control" id="Celular"  name="Celular" required placeholder="+00 000000000" pattern="[\(]?[\+]?(\d{2}|\d{3})[\)]?[\s]?((\d{6}|\d{8})|(\d{3}[\*\.\-\s]){3}|(\d{2}[\*\.\-\s]){4}|(\d{4}[\*\.\-\s]){2})|\d{8}|\d{10}|\d{12}" title="+### ########">
    <?php } ?>
